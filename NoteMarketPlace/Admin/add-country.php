                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="countryname" class="form-control input-light-color" placeholder="Enter your country name" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="form-group col-md-6 desc-detail">
                                    ...
                                    <input type="text" name="countrycode" class="form-control input-box input-light-color" placeholder="Enter your country code" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
