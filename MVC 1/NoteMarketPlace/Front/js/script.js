...
function sticky_header() {
  ...
  if (scrollTop > header_height) {
    ...
    $("#home-header .logo-wrapper img").attr(
      "src",
  ...
  if (scrollTop > header_height) {
    jQuery("body").addClass("sticky-header");
    $(
      "#home-header .white-nav .site-header .header-wrapper .navigation-wrapper .main-navigation .menu-navigation > li a "
    ).css("color", "#333333");
  } else {
    jQuery("body").addClass("sticky-header");
    $(
  ...
  if (scrollTop > header_height) {
    jQuery("body").addClass("sticky-header");
    $(
      "#home-header .white-nav .site-header .header-wrapper .navigation-wrapper .main-navigation .menu-navigation > li a.btn-general "
    ).css("color", "#fff");
  } else {
    jQuery("body").addClass("sticky-header");
    $(
